...
INSERT INTO employee(username,password,name,role_id,phone) SELECT 'adminbht','e10adc3949ba59abbe56e057f20f883e','管理员',1,'13800138000' WHERE NOT EXISTS(SELECT 1 FROM employee WHERE username='adminbht');
INSERT INTO employee(username,password,name,role_id,phone) SELECT 'bht01','e10adc3949ba59abbe56e057f20f883e','店长',2,'13800138001' WHERE NOT EXISTS(SELECT 1 FROM employee WHERE username='bht01');
...
INSERT INTO employee(username,password,name,role_id,phone) SELECT 'adminwx','e10adc3949ba59abbe56e057f20f883e','管理员',1,'13800138000' WHERE NOT EXISTS(SELECT 1 FROM employee WHERE username='adminwx');
INSERT INTO employee(username,password,name,role_id,phone) SELECT 'wx01','e10adc3949ba59abbe56e057f20f883e','店长',2,'13800138001' WHERE NOT EXISTS(SELECT 1 FROM employee WHERE username='wx01');
...
INSERT INTO employee(username,password,name,role_id,phone) SELECT 'adminrzt_db','e10adc3949ba59abbe56e057f20f883e','管理员',1,'13800138000' WHERE NOT EXISTS(SELECT 1 FROM employee WHERE username='adminrzt_db');
INSERT INTO employee(username,password,name,role_id,phone) SELECT 'rzt_db01','e10adc3949ba59abbe56e057f20f883e','店长',2,'13800138001' WHERE NOT EXISTS(SELECT 1 FROM employee WHERE username='rzt_db01');
...
-- 默认管理员 admin / 123456
INSERT INTO boss(username, password) SELECT 'admin', 'e10adc3949ba59abbe56e057f20f883e' WHERE NOT EXISTS(SELECT 1 FROM boss WHERE username='admin');
